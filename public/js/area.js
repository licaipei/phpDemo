...
dsy.add("0_5",["百色","北海","崇左","防城港","桂林","贵港","河池","贺州","来宾","柳州","南宁","钦州","梧州","玉林"]); 
  ...
  dsy.add("0_28",["昭通","保山","楚雄彝族自治州","大理白族自治州","德宏傣族景颇族自治州","迪庆藏族自治州","红河哈尼族彝族自治州","昆明","丽江","临沧","怒江傈傈族自治州","曲靖","思茅","文山壮族苗族自治州","西双版纳傣族自治州","玉溪"]); 
  dsy.add("0_28_0",["昭阳区","大关县","鲁甸县","巧家县","水富县","绥江县","威信县","盐津县","彝良县","永善县","镇雄县"]); 
  dsy.add("0_28_1",["保山市","昌宁县","龙陵县","施甸县","腾冲县"]); 
  dsy.add("0_28_2",["楚雄市","大姚县","禄丰县","牟定县","南华县","双柏县","武定县","姚安县","永仁县","元谋县"]); 
  dsy.add("0_28_3",["宾川县","大理市","洱源县","鹤庆县","剑川县","弥渡县","南涧彝族自治县","巍山彝族回族自治县","祥云县","漾濞彝族自治县","永平县","云龙县"]); 
  dsy.add("0_28_4",["梁河县","陇川县","潞西市","瑞丽市","盈江县"]); 
  dsy.add("0_28_5",["德钦县","维西傈僳族自治县","香格里拉县"]); 
  dsy.add("0_28_6",["个旧市","河口瑶族自治县","红河县","建水县","金平苗族瑶族傣族自治县","开远市","绿春县","蒙自县","弥勒县","屏边苗族自治县","石屏县","元阳县","泸西县"]); 
  dsy.add("0_28_7",["安宁市","呈贡县","富民县","晋宁县","昆明市","禄劝彝族苗族自治县","石林彝族自治县","寻甸回族自治县","宜良县","嵩明县"]); 
  dsy.add("0_28_8",["华坪县","丽江市","宁蒗彝族自治县","永胜县","玉龙纳西族自治县"]); 
  dsy.add("0_28_9",["沧源佤族自治县","凤庆县","耿马傣族佤族治县","临沧县","双江拉祜族佤族布朗族傣族自治县","永德县","云县","镇康县"]); 
  dsy.add("0_28_10",["福贡县","贡山独龙族怒族自治县","兰坪白族普米族自治县","泸水县"]); 
  dsy.add("0_28_11",["富源县","会泽县","陆良县","罗平县","马龙县","曲靖市","师宗县","宣威市","沾益县"]); 
  dsy.add("0_28_12",["江城哈尼族彝族自治县","景东彝族自治县","景谷彝族傣族自治县","澜沧拉祜族自治县","孟连傣族拉祜族佤族自治县","墨江哈尼族自治县","普洱哈尼族彝族自治县","思茅市","西盟佤族自治县","镇沅彝族哈尼族拉祜族自治县"]); 
  dsy.add("0_28_13",["富宁县","广南县","麻栗坡县","马关县","丘北县","文山县","西畴县","砚山县"]); 
  dsy.add("0_28_14",["景洪市","勐海县","勐腊县"]); 
  dsy.add("0_28_15",["澄江县","峨山彝族自治县","华宁县","江川县","通海县","新平彝族傣族自治县","易门县","玉溪市","元江哈尼族彝族傣族自治县"]); 
  ...
  function setup(province,city,county) 
  { 
