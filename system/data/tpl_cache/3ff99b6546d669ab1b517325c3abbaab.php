...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo __PUBLIC__; ?>/css/login.css">
  <!--[if IE]>
...
<body>
  <div class="signin">
    <div class="signin-head"><img src="<?php echo __PUBLIC__; ?>/images/head_1201.png" alt="" class="img-circle"></div>
    <div class="form-signin" role="form">
        <input type="text" id="username" class="form-control" placeholder="用户名" required autofocus />
        <input type="password" id="userpass" class="form-control" placeholder="密码" required />
        <button class="btn btn-lg btn-warning btn-block" type="submit" id="onlogin">登录系统</button>
        <div class="tips"></div>
    </div>
    <div class="copy"><?php echo $sys['systemname']; ?></div>
  </div>
  <script src="<?php echo __ROOT__; ?>/../public/bootstrap/plugins/jQuery/jquery-2.2.3.min.js"></script>
  <script src="<?php echo __PUBLIC__; ?>/js/supersized.3.2.7.min.js"></script>
  <script src="<?php echo __PUBLIC__; ?>/js/supersized-init.js"></script>
</body>
</html>